package io.aromko.kidsdrawingapp
...
class MainActivity : AppCompatActivity() {
    ...
    private var customPorgressDialog: Dialog? = null
    ...
    private fun showProgressDialog() {
        customPorgressDialog = Dialog(this@MainActivity)

        customPorgressDialog?.setContentView(R.layout.dialog_custom_progress)

        customPorgressDialog?.show()
    }

    private fun cancelProgressDialog() {
        if (customPorgressDialog != null) {
            customPorgressDialog?.dismiss()
            customPorgressDialog = null
        }
    }
